...
abstract public class World{
  ...
  public World testOnTick(){
	 ...
	 */
	protected World processMouseClicked(Position mouse){
		try{
		  if (this.worldExists){
	 ...
	 * @return <code>{@link World World}</code> after the mouse event
	 */
	public World onMouseClicked(Position mouse){
		return this;
	}
	 ...
	 * @return <code>{@link World World}</code> after the mouse event
	 */
	protected World processMouseEntered(Position mouse){
	 ...
	 * @return <code>{@link World World}</code> after the mouse event
	 */
	public World onMouseEntered(Position mouse){
		return this;
	}
	 ...
	 * @return <code>{@link World World}</code> after the mouse event
	 */
	protected World processMouseExited(Position mouse){
	 ...
	 * @return <code>{@link World World}</code> after the mouse event
	 */
	public World onMouseExited(Position mouse){
		return this;
	}
	 ...
	 * @return <code>{@link World World}</code> after the mouse event
	 */
	protected World processMousePressed(Position mouse){
	 ...
	 * @return <code>{@link World World}</code> after the mouse event
	 */
	public World onMousePressed(Position mouse){
		return this;
	}
	 ...
	 * @return <code>{@link World World}</code> after the mouse event
	 */
	protected World processMouseReleased(Position mouse){
	 ...
	 * @return <code>{@link World World}</code> after the mouse event
	 */
	public World onMouseReleased(Position mouse){
		return this;
	}

...
public class WorldCanvas {
   ...
   */
  public boolean drawImage(String fileName, Position nw){
   ...
   * @param nw the NW corner for the image placement
   */
  public boolean drawImage(ImageMaker image, Position nw){
  ...
  public static void main(String[] argv){
    ...
    sm1.drawImage(new CircleImage(new Position(50, 50), 20, new Red()));
    sm1.drawImage(new CircleImage(new Position(150, 50), 50, new Blue()));

    nextStep("Show the canvas again - it should not do anything");
    sm1.show();

    nextStep("Draw a green disk");
    sm1.drawImage(new CircleImage(new Position(50, 150), 50, new Green()));
    ...
    sm1.drawImage(new CircleImage(new Position(50, 150), 25, new Black()));
    ...
    sm2.drawImage(new CircleImage(new Position(50, 50), 20, new Red()));
    sm2.drawImage(new CircleImage(new Position(150, 150), 50, new Blue()));
    ...
    sm1.drawImage(new CircleImage(new Position(50, 50), 30, new Red()));
    sm1.drawImage(new CircleImage(new Position(150, 50), 30, new Blue()));
    sm1.drawImage(new CircleImage(new Position(50, 150), 30, new Green()));

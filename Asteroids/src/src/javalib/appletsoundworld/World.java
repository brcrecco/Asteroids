...
abstract public class World implements SoundConstants{
  ...
  private transient WorldImage blankImage = 
      new CircleImage(new Position(0, 0), 1, Color.white);
  ...
  protected void processTick(){
    try{
      ...
      this.lastWorld.lastImage.overlayImages(
          new TextImage(new Position(40, 40), re.getMessage(), Color.red));
      this.stopWorld();
      //throw re;
   ...
   */
  protected void processMouseClicked(Position mouse){
    try{
      if (this.worldExists){
   ...
   * @param mouse the location of the mouse when clicked
   */
  public void onMouseClicked(Position mouse){}
   ...
   */
  protected void processMouseEntered(Position mouse){
    try{
      if (this.worldExists){
        // process the mouse click
   ...
   * @param mouse the location of the mouse when entered
   */
  public void onMouseEntered(Position mouse){}  
   ...
   */
  protected void processMouseExited(Position mouse){
    try{
      if (this.worldExists){
        // process the mouse click
   ...
   * @param mouse the location of the mouse when exited
   */
  public void onMouseExited(Position mouse){}  
   ...
   */
  protected void processMousePressed(Position mouse){
    try{
      if (this.worldExists){
        // process the mouse click
   ...
   * @param mouse the location of the mouse when pressed
   */
  public void onMousePressed(Position mouse){}
   ...
   */
  protected void processMouseReleased(Position mouse){
    try{
      if (this.worldExists){
        // process the mouse click
   ...
   * @param mouse the location of the mouse when released
   */
  public void onMouseReleased(Position mouse){}
...
class MyMouseAdapter extends MouseAdapter {
   ...
   */ 
  Position adjustMousePosn(Position mousePosn){
  ...
  public void mouseClicked(MouseEvent e) {
    ...
    this.mousePosn = new Position(e.getX(), e.getY());

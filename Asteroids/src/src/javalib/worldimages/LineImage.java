...
public class LineImage extends WorldImage{
   ...
   */ 
  public LineImage(Position startPoint, Position endPoint, Color color){
    super(startPoint, color);
    this.startPoint = new Position(startPoint.x, startPoint.y);
    this.endPoint = new Position(endPoint.x, endPoint.y);
   ...
   * @param color the color for this image
   */
  public LineImage(Position startPoint, Position endPoint, IColor color){

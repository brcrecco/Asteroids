...
public abstract class WorldImage{
   ...
   */
  public WorldImage(Position pinhole, Color color){
    this.pinhole = new Position(pinhole.x, pinhole.y);
    this.color = color;
  }  
   ...
   * @param color the color for this image
   */
  public WorldImage(Position pinhole, IColor color){
   ...
   */
  abstract public WorldImage getMovedTo(Position p);
   ...
   */
  protected Position movePosn(Position p, int dx, int dy){
  ...
  protected static String pinholeString(String indent, Position pin){

...
public class EllipseImage extends WorldImage{
   ...
   */   
  public EllipseImage(Position pinhole, int width, int height, Color color){
    super(pinhole, color);
    this.width = width;
    this.height = height;
  }
   ...
   * @param color the color for this image
   */
  public EllipseImage(Position pinhole, int width, int height, IColor color){
    super(pinhole, color);
    this.width = width;
    this.height = height;
  }
  ...
  public WorldImage getMovedImage(int dx, int dy){
    return new EllipseImage(new Position(this.pinhole.x + dx, this.pinhole.y + dy), 

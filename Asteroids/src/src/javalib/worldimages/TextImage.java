...
public class TextImage extends WorldImage{
   ...
   */ 
  public TextImage(Position pinhole, String text, float size, int style, Color color){
    super(pinhole, color);
   ...
   * @param color the color for this image
   */ 
  public TextImage(Position pinhole, String text, int size, int style, Color color){
    super(pinhole, color);
    // bad things happen if we want to display a null String 
    // or a String of length 0
    if (text == null || text.equals(""))
   ...
   * @param color the color for this image
   */
  public TextImage(Position pinhole, String text, float size, Color color){
   ...
   * @param color the color for this image
   */
  public TextImage(Position pinhole, String text, int size, Color color){
    this(pinhole, text, size, 0, color);
  }
   ...
   * @param color the color for this image
   */
  public TextImage(Position pinhole, String text, Color color){
   ...
   * @param color the color for this image
   */
  public TextImage(Position pinhole, String text, float size, int style, IColor color){
   ...
   * @param color the color for this image
   */
  public TextImage(Position pinhole, String text, int size, int style, IColor color){
    this(pinhole, text, size, style, color.thisColor());
  }
   ...
   * @param color the color for this image
   */
  public TextImage(Position pinhole, String text, float size, IColor color){
    this(pinhole, text, size, 0, color);
  }
   ...
   * @param color the color for this image
   */
  public TextImage(Position pinhole, String text, int size, IColor color){
    this(pinhole, text, size, 0, color);
  }
   ...
   * @param color the color for this image
   */
  public TextImage(Position pinhole, String text, IColor color){
    this(pinhole, text, 13, 0, color);
  }
   ...
   */
  public WorldImage getMovedTo(Position p){

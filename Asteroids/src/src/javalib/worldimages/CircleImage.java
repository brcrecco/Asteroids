...
public class CircleImage extends WorldImage{
   ...
   */ 
  public CircleImage(Position pinhole, int radius, Color color){
    super(pinhole, color);
    this.radius = radius;
  }
   ...
   * @param color the color for this image
   */
  public CircleImage(Position pinhole, int radius, IColor color){
    super(pinhole, color);
    this.radius = radius;
  }
  ...
  public WorldImage getMovedImage(int dx, int dy){
    return new CircleImage(new Position(this.pinhole.x + dx, this.pinhole.y + dy), 

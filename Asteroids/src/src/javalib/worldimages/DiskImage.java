...
public class DiskImage extends WorldImage{
   ...
   */
  public DiskImage(Position pinhole, int radius, Color color){
    super(pinhole, color);
    this.radius = radius;
  }
   ...
   * @param color the color for this image
   */
  public DiskImage(Position pinhole, int radius, IColor color){
    super(pinhole, color);
    this.radius = radius;
  }
  ...
  public WorldImage getMovedImage(int dx, int dy){
    return new DiskImage(new Position(this.pinhole.x + dx, this.pinhole.y + dy), 

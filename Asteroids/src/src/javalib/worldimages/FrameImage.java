...
public class FrameImage extends WorldImage{
   ...
   */
  public FrameImage(Position pinhole, int width, int height, Color color){
    super(pinhole, color);
    this.width = width;
    this.height = height;
  }
  ...
  public FrameImage(Position pinhole, int width, int height, IColor color){
    super(pinhole, color);
    this.width = width;
    this.height = height;
  }
  ...
  public WorldImage getMovedImage(int dx, int dy){
    return new FrameImage(new Position(this.pinhole.x + dx, this.pinhole.y + dy), 

...
public class OvalImage extends WorldImage{
   ...
   */ 
  public OvalImage(Position pinhole, int width, int height, Color color){
    super(pinhole, color);
    this.width = width;
    this.height = height;
  }
   ...
   * @param color the color for this image
   */
  public OvalImage(Position pinhole, int width, int height, IColor color){
    super(pinhole, color);
    this.width = width;
    this.height = height;
  }
  ...
  public WorldImage getMovedImage(int dx, int dy){
    return new OvalImage(new Position(this.pinhole.x + dx, this.pinhole.y + dy), 
